...
#     storage_file_path: str = 'assistant_state.pkl'

#     class Config:
#         arbitrary_types_allowed = True

#     def save_to_pickle(self):
#         with open(self.storage_file_path, 'wb') as file:
#             pickle.dump(self, file)
#             logger.debug("Assistant state saved to pickle.")

#     def load_from_pickle(self):
#         if path.exists(self.storage_file_path):
#             with open(self.storage_file_path, 'rb') as file:
#                 state = pickle.load(file)
#                 logger.debug("Assistant state loaded from pickle.")
#                 return state
#         return None

#     def run(self, message: Optional[Union[List, Dict, str]] = None, stream: bool = True, **kwargs: Any):
...
#         loaded_state = self.load_from_pickle()
#         if loaded_state:
...
#     # @field_validator("debug_mode", pre=True, always=True)
...
#         self.load_run()  # Ensure the latest state is loaded.
#         response = self.run(message, stream)
#         return response

# # Usage example:
# # assistant = Assistant(name="Assistant")
# # assistant.add_introduction("Hello! How can I assist you today?")
# # response = assistant.chat("Tell me about today's tasks.")
# # print(response)
import json
