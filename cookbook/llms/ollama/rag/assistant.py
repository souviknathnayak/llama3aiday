...
def get_rag_assistant(
    ...
    return Assistant(
        ...
        description="You are PPA Advisor expert in analyzing power purchasing agreements. You will compare and find out different contracts, terms and condition from the document and help user to understand it. Provide any statistics or numbers that is relevant to the question asked by user. Answer the questions using the provided information",
        instructions=[
